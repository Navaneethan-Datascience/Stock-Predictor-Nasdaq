...
model = SVR(kernel='rbf', C=100, epsilon=0.1)  # RBF kernel for non-linear regression
model.fit(X_train, y_train)

# Save the model
with open('D:/Project/Sector stock prediction/model1/communication_services1.pkl', 'wb') as file:
