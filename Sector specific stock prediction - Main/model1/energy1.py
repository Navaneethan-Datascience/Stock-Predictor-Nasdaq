...
# Prepare data for Random Forest (no sequences, just features and target)
...
model = RandomForestRegressor(n_estimators=100, random_state=42)  # 100 trees, fixed seed for reproducibility
model.fit(X_train, y_train)

# Save the model
with open('D:/Project/Sector stock prediction/model1/energy1.pkl', 'wb') as file:
