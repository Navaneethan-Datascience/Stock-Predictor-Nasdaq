...
# Prepare data for SVR (no sequences, just features and target)
...
# 4. BUILD THE SVR MODEL
model = SVR(kernel='rbf', C=100, epsilon=0.1)  # RBF kernel is commonly used for non-linear regression
model.fit(X_train, y_train)

# Save the model
with open('D:/Project/Sector stock prediction/model1/real_estate1.pkl', 'wb') as file:
