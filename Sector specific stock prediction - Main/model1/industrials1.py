...
model = Sequential([
    SimpleRNN(units=100, return_sequences=True, input_shape=(sequence_length, x_train.shape[2])),
    Dropout(0.2),
...
model.save('D:/Project/Sector stock prediction/model1/industrials1.h5')
