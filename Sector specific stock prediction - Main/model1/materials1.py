...
# Prepare data for Gradient Boosting (no sequences, just features and target)
...
# 4. BUILD THE GRADIENT BOOSTING MODEL
model = GradientBoostingRegressor(n_estimators=100, learning_rate=0.1, max_depth=3, random_state=42)
model.fit(X_train, y_train)

# Save the model
with open('D:/Project/Sector stock prediction/model1/materials1.pkl', 'wb') as file:
